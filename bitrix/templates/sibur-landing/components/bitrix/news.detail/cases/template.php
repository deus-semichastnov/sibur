...
<? $APPLICATION->IncludeComponent(
            ...
            array(
                "AREA_FILE_SHOW" => "file",
                "PATH" => SITE_TEMPLATE_PATH."/include/".SITE_ID."/main/empty_cases.php",
                "EDIT_TEMPLATE" => ""
            )
        ); ?>
<?else:?>
<!-- БЛОК С КЕЙСАМИ -->
<section class="cases section" data-href="cases" id="cases">
    <div class="container">
        <div class="cases__wrap">
            <div class="cases__head">
                ...
                <h2 class="heading-secondary" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100"><?= $arResult["PROPERTIES"]["TITLE_BLOCK"]["VALUE"] ?></h2>
                <div class="cases__subtitle" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200"><?= $arResult["PREVIEW_TEXT"] ?></div>
            </div>
                ...
                <div class="cases__slider-nav">
                    <div class="cases__slider-prev">
                        <svg width="40" height="41" viewBox="0 0 40 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle r="19.3174" transform="matrix(-1 0 0 1 19.9853 20.263)" stroke="#DBDDDF" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.1832 15.9177L12.8384 20.2625L17.1832 24.6072L18.1355 23.6548L15.4166 20.9359H27.1328V19.589H15.4166L18.1355 16.8701L17.1832 15.9177Z" fill="white" />
                        </svg>
                    </div>
                    <div class="cases__slider-amount"><span class="current">3</span> из <span class="total"><?= count($arCases) ?></span> кейсов</div>
                    <div class="cases__slider-next">
                        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="20.4239" cy="20.3958" r="19.3174" stroke="#DBDDDF" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M23.2265 16.0505L27.5713 20.3953L23.2265 24.74L22.2741 23.7877L24.9931 21.0687H13.2769V19.7219H24.9931L22.2741 17.0029L23.2265 16.0505Z" fill="white" />
                        </svg>
                    </div>
                </div>
                <?endif;?>
                ...
                <div class="cases__c --cases">
                    ...
                    <div class="cases__item<?= $active ?>" data-case="<?= $num ?>">
                        <div class="cases__item-wrap">
                            ...
                            <a href="<?= $arParams["LINK"] ?>" class="btn --green fancybox-link-quest" data-variant="2" data-case="<?= $case["FIELDS"]["ID"] ?>" data-template="FEEDBACK_2">
                                Подать заявку
                                <div class="btn__plus">
